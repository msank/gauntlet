...
(function(angular){
    ...
    .constant('ngJcroptDefaultConfig', {
        widthLimit: 1000,
        heightLimit: 1000,
        previewImgStyle: {'width': '800px', 'height': '800px', 'overflow': 'hidden', 'margin-left': '5px'},
        jcrop: {
            maxWidth: 3000,
            maxHeight: 3000
        }
    ...
    .directive('ngJcrop', ['ngJcropConfig', function(ngJcropConfig){
        ...
        return {
            restrict: 'A',
            scope: { ngJcrop: '=', thumbnail: '=', selection: '=', coords: '=' },
    ...
    function($scope, $element, ngJcropConfig){
        ...
        $scope.initMainImage = function(src){
            ...
            $scope.mainImg = $('<img>').attr('id', 'ngJcropBoxImg');
            $scope.mainImg.on('load', $scope.onMainImageLoad);
            $scope.mainImg.css({ maxWidth: "100%", maxHeight: ngJcropConfig.jcrop.maxHeight });
