(function ($) {
  $.fn.annotatableImage = function (annotationCallback, options) {
    var defaults = {xPosition: 'middle', yPosition: 'middle'};
  ...
  $.fn.relativeX = function (xPosition) {
    var left = $(this).pointInfo().x + ($(this).xOffset(xPosition));
    var width = $(this).parent().width();
    return left / width;
  }
  $.fn.relativeY = function (yPosition) {
    var top = $(this).pointInfo().y + ($(this).yOffset(yPosition));
